...
fun MainMetronomeScreen() {
    Scaffold(
        ...
        Column(
            ...
            val itemCount = 4
            MetronomeBalls(
                modifier = Modifier.padding(top = 128.dp, bottom = 64.dp),
...
//                    arrangementSpacing = ,
            ...
            Column(
                ...
                Row(
                    ...
                    MyIconButton(modifier = Modifier.size(80.dp), Icons.Default.Remove) {}
                    Text(
                    ...
                    MyIconButton(modifier = Modifier.size(80.dp), Icons.Default.Add) {}
                }
            }
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MyIconButton(modifier: Modifier, icon: ImageVector, onClick: () -> Unit) {
    Card(modifier = modifier, onClick = onClick, shape = CircleShape) {
