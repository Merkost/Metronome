...
VERB_DESC_GAP = 20
DESC_LINE_GAP = 24
MAX_TEXT_W = int(CANVAS_W * 0.82)
MAX_VERB_W = int(CANVAS_W * 0.82)

FONT_PATH = "/System/Library/Fonts/SFNS.ttf"
FONT_WEIGHT = "Bold"
FRAME_PATH = os.path.expanduser("~/.claude/skills/aso-appstore-screenshots/assets/device_frame.png")
...
def compose(bg_hex, verb, desc, screenshot_path, output_path):
    ...
    dummy = ImageDraw.Draw(Image.new("RGBA", (1, 1)))
    m_y = 0
    m_y = draw_centered(dummy, m_y, verb, verb_font)
    m_y += VERB_DESC_GAP
    text_height = draw_centered(dummy, m_y, desc, desc_font, max_w=MAX_TEXT_W)
